...
import com.bs.youmin.adapter.GalleryAdapter;
import com.bs.youmin.entity.Constants;
import com.bs.youmin.util.L;
import com.bs.youmin.util.ScreenUtils;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.iv_preview_down:
                RxVolley.download(FileUtils.getSDCardPath() + "/YouMin/" + System.currentTimeMillis() + ".png"
